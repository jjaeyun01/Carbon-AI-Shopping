...
export default function MostViewedSection() {
    ...
    const fetchMostViewedProducts = async () => {
      try {
        ...
        const res = await fetch(
          "http://127.0.0.1:8000/user-actions/most-viewed-products"
        );
  ...
  if (loading) {
    return (
      <section className="section mostViewedSection">
        <div className="container">
          <p className="sectionMessage">Loading trending products...</p>
        </div>
      </section>
    );
  }
    ...
    <section className="section mostViewedSection">
      <div className="container">
        <div className="curatedTop">
          <div>
            <h2 className="curatedTitle">Trending Now</h2>
            <p className="curatedSub">
              Products users are exploring most across the platform.
            </p>
          </div>
        </div>
